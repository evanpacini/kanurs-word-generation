...
class TestBuildMarkovChain(unittest.TestCase):
    @parameterized.expand(
        [
            ...
            (
                ["hello"],
                5,
                {"hello": {"ello.": 1}, "initial": {"hello": 1}, "names": {"hello"}},
            ),
            ...
            (
                ["hi", "bye"],
                3,
                {"bye": {"ye.": 1}, "initial": {"bye": 1}, "names": {"hi", "bye"}},
            ),
            (
                ["hello", "world"],
                5,
            ...
            (
                ...
                2,
                {
                    ...
                    "el": {"ll": 1},
                    "he": {"el": 1},
                    "initial": {"12": 1, "he": 1, "wo": 1},
                    "ld": {"d.": 1},
                    "ll": {"lo": 1},
                    "lo": {"o.": 1},
                    "names": {"123", "world", "hello"},
                    "or": {"rl": 1},
                    "rl": {"ld": 1},
                    "wo": {"or": 1},
                },
    ...
    def test_build_markov_chain_max_input(self):
        max_input = ["a" * 100] * 100
        self.assertEqual(
            {"initial": {"a": 100}, "names": {"a" * 100}, "a": {".": 100, "a": 9900}},
            build_markov_chain(max_input, 1),
        )
